	...
	public static Feature<?> feature() {
		...
		CONFIGURED_FEATURE = FeatureUtils.register("gildedsky:gilded_dark_stone", FEATURE,
				new OreConfiguration(List.of(
						OreConfiguration.target(new BlockStateMatchTest(Blocks.STONE.defaultBlockState()),
								GildedskyModBlocks.GILDED_DARK_STONE.get().defaultBlockState()),
		...
		PLACED_FEATURE = PlacementUtils.register("gildedsky:gilded_dark_stone", CONFIGURED_FEATURE,
				List.of(CountPlacement.of(2), InSquarePlacement.spread(),
						HeightRangePlacement.uniform(VerticalAnchor.absolute(-62), VerticalAnchor.absolute(0)), BiomeFilter.biome()));
		return FEATURE;
	}
