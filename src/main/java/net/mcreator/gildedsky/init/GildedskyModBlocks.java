...
import net.mcreator.gildedsky.block.SkyOakWoodBlock;
import net.mcreator.gildedsky.block.SkyOakStairsBlock;
import net.mcreator.gildedsky.block.SkyOakSlabBlock;
import net.mcreator.gildedsky.block.SkyOakPressurePlateBlock;
import net.mcreator.gildedsky.block.SkyOakPlanksBlock;
import net.mcreator.gildedsky.block.SkyOakLogBlock;
import net.mcreator.gildedsky.block.SkyOakLeavesBlock;
import net.mcreator.gildedsky.block.SkyOakFenceGateBlock;
import net.mcreator.gildedsky.block.SkyOakFenceBlock;
import net.mcreator.gildedsky.block.SkyOakButtonBlock;
...
public class GildedskyModBlocks {
	...
	public static final RegistryObject<Block> SKY_OAK_WOOD = REGISTRY.register("sky_oak_wood", () -> new SkyOakWoodBlock());
	public static final RegistryObject<Block> SKY_OAK_LOG = REGISTRY.register("sky_oak_log", () -> new SkyOakLogBlock());
	public static final RegistryObject<Block> SKY_OAK_PLANKS = REGISTRY.register("sky_oak_planks", () -> new SkyOakPlanksBlock());
	public static final RegistryObject<Block> SKY_OAK_LEAVES = REGISTRY.register("sky_oak_leaves", () -> new SkyOakLeavesBlock());
	public static final RegistryObject<Block> SKY_OAK_STAIRS = REGISTRY.register("sky_oak_stairs", () -> new SkyOakStairsBlock());
	public static final RegistryObject<Block> SKY_OAK_SLAB = REGISTRY.register("sky_oak_slab", () -> new SkyOakSlabBlock());
	public static final RegistryObject<Block> SKY_OAK_FENCE = REGISTRY.register("sky_oak_fence", () -> new SkyOakFenceBlock());
	public static final RegistryObject<Block> SKY_OAK_FENCE_GATE = REGISTRY.register("sky_oak_fence_gate", () -> new SkyOakFenceGateBlock());
	public static final RegistryObject<Block> SKY_OAK_PRESSURE_PLATE = REGISTRY.register("sky_oak_pressure_plate", () -> new SkyOakPressurePlateBlock());
	public static final RegistryObject<Block> SKY_OAK_BUTTON = REGISTRY.register("sky_oak_button", () -> new SkyOakButtonBlock());
}
